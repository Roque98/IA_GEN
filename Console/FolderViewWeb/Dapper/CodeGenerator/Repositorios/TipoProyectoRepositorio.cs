...
namespace FolderView.Dapper.Repositorios
{
    public class TipoProyectoRepositorio : ITipoProyectoRepository
    {
        ...
        {
            var query = "IA_GEN..[CodeGenerator_Tipo_proyecto_Add]";
        ...
        {
            var query = "IA_GEN..[CodeGenerator_Tipo_proyecto_GetById]";
            var connection = _context.CreateConnection();
        ...
        {
            var query = "IA_GEN..[CodeGenerator_Tipo_proyecto_Update]";
            var connection = _context.CreateConnection();
        ...
        {
            var query = "IA_GEN..[CodeGenerator_Tipo_proyecto_Delete]";
            var connection = _context.CreateConnection();
            var resultado = await connection.QuerySingleOrDefaultAsync<TipoProyectoEntidad>(query, new { id }, commandType: CommandType.StoredProcedure);
            return resultado;
        }
        ...
        {
            var query = "IA_GEN..[CodeGenerator_Tipo_proyecto_GetAll]";
            var connection = _context.CreateConnection();
