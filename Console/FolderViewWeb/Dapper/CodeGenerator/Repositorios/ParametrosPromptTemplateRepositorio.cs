...
namespace FolderView.Dapper.CodeGenerator.Repositorios
{
    public class ParametrosPromptTemplateRepositorio : IParametrosPromptTemplateRepository
    {
        ...
        public ParametrosPromptTemplateRepositorio(
        ...
        {
            var query = $"{DBNAME}..[CodeGenerator_ParametrosPromptTemplate_Add]";
        ...
        {
            var query = $"{DBNAME}..[CodeGenerator_ParametrosPromptTemplate_GetById]";
            var connection = _context.CreateConnection();
        ...
        {
            var query = $"{DBNAME}..[CodeGenerator_ParametrosPromptTemplate_Update]";
            var connection = _context.CreateConnection();
        ...
        {
            var query = $"{DBNAME}..[CodeGenerator_ParametrosPromptTemplate_Delete]";
            var connection = _context.CreateConnection();
            var resultado = await connection.QuerySingleOrDefaultAsync<ParametrosPromptTemplateEntidad>(query, new { id }, commandType: CommandType.StoredProcedure);
            return resultado;
        }
        ...
        {
            var query = $"{DBNAME}..[CodeGenerator_ParametrosPromptTemplate_GetAllByPromptTemplate]";
            var connection = _context.CreateConnection();
